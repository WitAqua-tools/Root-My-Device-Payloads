...
| `pmg110-16.0.9.400` | OPPO PMG110 / K15 Pro+ (MediaTek MT6991) | `PMG110_16.0.9.400(CN01)` | `6.6.118-android15-8-...-abogki500782043-4k` | Offsets cross-checked against a verified port; this payload not device-tested, no feed entry yet |
