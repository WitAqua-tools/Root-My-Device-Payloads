...
#define BUILD_VARIANT_LABEL "pa3q-S938NKSUACZF1-app-fast-p0-bank"
#else
...
#define SLIDE_P0_OFFSET_CANDIDATES \
  ...
  0x120000ULL, 0x150000ULL, 0x170000ULL, 0x140000ULL, \
  0x190000ULL, 0x1b0000ULL, 0x1d0000ULL, 0x1f0000ULL
#define SLIDE_MAX_ATTEMPTS 32
#if defined(APP_PAYLOAD) && APP_PAYLOAD
#define APPENDED_FUTEXES 1024
#define REPEAT_MEASUREMENT 32
#define AVERAGE (1 << 2)
#define SLIDE_PSELECT_TIMEOUT_NSEC 200000000L
#define SLIDE_BANK_TASK_OFF 0x1000
#define SLIDE_BANK_TASK_STRIDE 0x100
#define SLIDE_BANK_LOCK_OFF 0x4000
